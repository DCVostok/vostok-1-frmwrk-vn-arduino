/**
  ...
  * @file    plib028.h
  *
  * @brief   Низкоуровневая библиотека периферии для микроконтроллера НИИЭТ К1921ВК028
  *          Этот файл содержит:
...
/** @addtogroup PLib028 Библиотека периферии
  * @{
  */
...
#else
#error "plib028.h: RAMFUNC - нет реализации под данный компилятор!"
#endif
...
#include "plib028_assert.h"
#include "plib028_version.h"
