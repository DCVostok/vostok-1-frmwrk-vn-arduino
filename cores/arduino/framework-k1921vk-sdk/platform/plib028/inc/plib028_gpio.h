...
#ifndef __PLIB028_GPIO_H
#define __PLIB028_GPIO_H
...
/**
  ...
  */
typedef enum {
    GPIO_DriveMode_High = GPIO_DRIVEMODE_PIN0_HS, /*!< Высокая нагрузочная способность */
    GPIO_DriveMode_Low = GPIO_DRIVEMODE_PIN0_LS   /*!< Низкая нагрузочная способность*/
} GPIO_DriveMode_TypeDef;
#define IS_GPIO_DRIVE_MODE(VALUE) (((VALUE) == GPIO_DriveMode_High) || \
                                   ((VALUE) == GPIO_DriveMode_Low))
...
/**
  ...
  */
typedef enum {
    GPIO_AltFuncNum_None = GPIO_ALTFUNCNUM0_PIN0_Disable, /*!< Альтернативная функция не выбрана */
    GPIO_AltFuncNum_1 = GPIO_ALTFUNCNUM0_PIN0_AF1,        /*!< Альтернативная функция 1 */
    GPIO_AltFuncNum_2 = GPIO_ALTFUNCNUM0_PIN0_AF2,        /*!< Альтернативная функция 2 */
    GPIO_AltFuncNum_3 = GPIO_ALTFUNCNUM0_PIN0_AF3,        /*!< Альтернативная функция 3 */
    GPIO_AltFuncNum_4 = GPIO_ALTFUNCNUM0_PIN0_AF4         /*!< Альтернативная функция 4 */
...
typedef struct
{
    ...
    GPIO_DriveMode_TypeDef DriveMode;   /*!< Определяет нагрузочную способность выбранных пинов */
} GPIO_Init_TypeDef;
