...
#ifndef __PLIB028_PWM_H
#define __PLIB028_PWM_H
...
#define PWM_TB_Presc_3 (0x8UL << SIU_PWMSYNC_PRESCRST_Pos)   /*!< Предделитель блока ШИМ3 */
#define PWM_TB_Presc_4 (0x10UL << SIU_PWMSYNC_PRESCRST_Pos)  /*!< Предделитель блока ШИМ4 */
#define PWM_TB_Presc_5 (0x20UL << SIU_PWMSYNC_PRESCRST_Pos)  /*!< Предделитель блока ШИМ5 */
#define PWM_TB_Presc_6 (0x40UL << SIU_PWMSYNC_PRESCRST_Pos)  /*!< Предделитель блока ШИМ6 */
#define PWM_TB_Presc_7 (0x80UL << SIU_PWMSYNC_PRESCRST_Pos)  /*!< Предделитель блока ШИМ7 */
#define PWM_TB_Presc_8 (0x100UL << SIU_PWMSYNC_PRESCRST_Pos) /*!< Предделитель блока ШИМ8 */
#define PWM_TB_Presc_9 (0x200UL << SIU_PWMSYNC_PRESCRST_Pos) /*!< Предделитель блока ШИМ9 */
#define PWM_TB_Presc_All (PWM_TB_Presc_0 | \
                          ...
                          PWM_TB_Presc_7 | \
                          PWM_TB_Presc_8 | \
                          PWM_TB_Presc_9) /*!< Все блоки выбраны */
...
/** @defgroup PWM_HD_Source0_Define Выбор источника события удержания группа 0
  * @{
  */

#define PWM_HD_Source0_ADCDC0 PWM_HDSEL0_ADCDC0_Msk   /*!< Сигнал от цифрового компаратора 0 АЦП */
#define PWM_HD_Source0_ADCDC1 PWM_HDSEL0_ADCDC1_Msk   /*!< Сигнал от цифрового компаратора 1 АЦП */
#define PWM_HD_Source0_ADCDC2 PWM_HDSEL0_ADCDC2_Msk   /*!< Сигнал от цифрового компаратора 2 АЦП */
#define PWM_HD_Source0_ADCDC3 PWM_HDSEL0_ADCDC3_Msk   /*!< Сигнал от цифрового компаратора 3 АЦП */
#define PWM_HD_Source0_ADCDC4 PWM_HDSEL0_ADCDC4_Msk   /*!< Сигнал от цифрового компаратора 4 АЦП */
#define PWM_HD_Source0_ADCDC5 PWM_HDSEL0_ADCDC5_Msk   /*!< Сигнал от цифрового компаратора 5 АЦП */
#define PWM_HD_Source0_ADCDC6 PWM_HDSEL0_ADCDC6_Msk   /*!< Сигнал от цифрового компаратора 6 АЦП */
#define PWM_HD_Source0_ADCDC7 PWM_HDSEL0_ADCDC7_Msk   /*!< Сигнал от цифрового компаратора 7 АЦП */
#define PWM_HD_Source0_ADCDC8 PWM_HDSEL0_ADCDC8_Msk   /*!< Сигнал от цифрового компаратора 8 АЦП */
#define PWM_HD_Source0_ADCDC9 PWM_HDSEL0_ADCDC9_Msk   /*!< Сигнал от цифрового компаратора 9 АЦП */
#define PWM_HD_Source0_ADCDC10 PWM_HDSEL0_ADCDC10_Msk /*!< Сигнал от цифрового компаратора 10 АЦП */
#define PWM_HD_Source0_ADCDC11 PWM_HDSEL0_ADCDC11_Msk /*!< Сигнал от цифрового компаратора 11 АЦП */
#define PWM_HD_Source0_ADCDC12 PWM_HDSEL0_ADCDC12_Msk /*!< Сигнал от цифрового компаратора 12 АЦП */
#define PWM_HD_Source0_ADCDC13 PWM_HDSEL0_ADCDC13_Msk /*!< Сигнал от цифрового компаратора 13 АЦП */
#define PWM_HD_Source0_ADCDC14 PWM_HDSEL0_ADCDC14_Msk /*!< Сигнал от цифрового компаратора 14 АЦП */
#define PWM_HD_Source0_ADCDC15 PWM_HDSEL0_ADCDC15_Msk /*!< Сигнал от цифрового компаратора 15 АЦП */
#define PWM_HD_Source0_ADCDC16 PWM_HDSEL0_ADCDC16_Msk /*!< Сигнал от цифрового компаратора 16 АЦП */
#define PWM_HD_Source0_ADCDC17 PWM_HDSEL0_ADCDC17_Msk /*!< Сигнал от цифрового компаратора 17 АЦП */
#define PWM_HD_Source0_ADCDC18 PWM_HDSEL0_ADCDC18_Msk /*!< Сигнал от цифрового компаратора 18 АЦП */
#define PWM_HD_Source0_ADCDC19 PWM_HDSEL0_ADCDC19_Msk /*!< Сигнал от цифрового компаратора 19 АЦП */
#define PWM_HD_Source0_ADCDC20 PWM_HDSEL0_ADCDC20_Msk /*!< Сигнал от цифрового компаратора 20 АЦП */
#define PWM_HD_Source0_ADCDC21 PWM_HDSEL0_ADCDC21_Msk /*!< Сигнал от цифрового компаратора 21 АЦП */
#define PWM_HD_Source0_ADCDC22 PWM_HDSEL0_ADCDC22_Msk /*!< Сигнал от цифрового компаратора 22 АЦП */
#define PWM_HD_Source0_ADCDC23 PWM_HDSEL0_ADCDC23_Msk /*!< Сигнал от цифрового компаратора 23 АЦП */

#define PWM_HD_Source0_All (PWM_HD_Source0_ADCDC0 |  \
                            PWM_HD_Source0_ADCDC1 |  \
                            PWM_HD_Source0_ADCDC2 |  \
                            PWM_HD_Source0_ADCDC3 |  \
                            PWM_HD_Source0_ADCDC4 |  \
                            PWM_HD_Source0_ADCDC5 |  \
                            PWM_HD_Source0_ADCDC6 |  \
                            PWM_HD_Source0_ADCDC7 |  \
                            PWM_HD_Source0_ADCDC8 |  \
                            PWM_HD_Source0_ADCDC9 |  \
                            PWM_HD_Source0_ADCDC10 | \
                            PWM_HD_Source0_ADCDC11 | \
                            PWM_HD_Source0_ADCDC12 | \
                            PWM_HD_Source0_ADCDC13 | \
                            PWM_HD_Source0_ADCDC14 | \
                            PWM_HD_Source0_ADCDC15 | \
                            PWM_HD_Source0_ADCDC16 | \
                            PWM_HD_Source0_ADCDC17 | \
                            PWM_HD_Source0_ADCDC18 | \
                            PWM_HD_Source0_ADCDC19 | \
                            PWM_HD_Source0_ADCDC20 | \
                            PWM_HD_Source0_ADCDC21 | \
                            PWM_HD_Source0_ADCDC22 | \
                            PWM_HD_Source0_ADCDC23) /*!< Все источники выбраны */

#define IS_PWM_HD_SOURCE0(VALUE) (((VALUE) & ~PWM_HD_Source0_All) == 0)

/**
  * @}
  */

/** @defgroup PWM_HD_Source1_Define Выбор источника события удержания группа 1
  * @{
  */

#define PWM_HD_Source1_SDFMH0 PWM_HDSEL1_SDFMH0_Msk /*!< Сигнал от компаратора 0 SDFM "результат >= CMPH" */
#define PWM_HD_Source1_SDFMH1 PWM_HDSEL1_SDFMH1_Msk /*!< Сигнал от компаратора 1 SDFM "результат >= CMPH" */
#define PWM_HD_Source1_SDFMH2 PWM_HDSEL1_SDFMH2_Msk /*!< Сигнал от компаратора 2 SDFM "результат >= CMPH" */
#define PWM_HD_Source1_SDFMH3 PWM_HDSEL1_SDFMH3_Msk /*!< Сигнал от компаратора 3 SDFM "результат >= CMPH" */
#define PWM_HD_Source1_SDFML0 PWM_HDSEL1_SDFML0_Msk /*!< Сигнал от компаратора 0 SDFM "результат <= CMPL" */
#define PWM_HD_Source1_SDFML1 PWM_HDSEL1_SDFML1_Msk /*!< Сигнал от компаратора 1 SDFM "результат <= CMPL" */
#define PWM_HD_Source1_SDFML2 PWM_HDSEL1_SDFML2_Msk /*!< Сигнал от компаратора 2 SDFM "результат <= CMPL" */
#define PWM_HD_Source1_SDFML3 PWM_HDSEL1_SDFML3_Msk /*!< Сигнал от компаратора 3 SDFM "результат <= CMPL" */
#define PWM_HD_Source1_SDFMZ0 PWM_HDSEL1_SDFMZ0_Msk /*!< Сигнал от компаратора 0 SDFM "результат >= CMPHZ" */
#define PWM_HD_Source1_SDFMZ1 PWM_HDSEL1_SDFMZ1_Msk /*!< Сигнал от компаратора 1 SDFM "результат >= CMPHZ" */
#define PWM_HD_Source1_SDFMZ2 PWM_HDSEL1_SDFMZ2_Msk /*!< Сигнал от компаратора 2 SDFM "результат >= CMPHZ" */
#define PWM_HD_Source1_SDFMZ3 PWM_HDSEL1_SDFMZ3_Msk /*!< Сигнал от компаратора 3 SDFM "результат >= CMPHZ" */

#define PWM_HD_Source1_All (PWM_HD_Source1_SDFMH0 | \
                            PWM_HD_Source1_SDFMH1 | \
                            PWM_HD_Source1_SDFMH2 | \
                            PWM_HD_Source1_SDFMH3 | \
                            PWM_HD_Source1_SDFML0 | \
                            PWM_HD_Source1_SDFML1 | \
                            PWM_HD_Source1_SDFML2 | \
                            PWM_HD_Source1_SDFML3 | \
                            PWM_HD_Source1_SDFMZ0 | \
                            PWM_HD_Source1_SDFMZ1 | \
                            PWM_HD_Source1_SDFMZ2 | \
                            PWM_HD_Source1_SDFMZ3) /*!< Все источники выбраны */

#define IS_PWM_HD_SOURCE1(VALUE) (((VALUE) & ~PWM_HD_Source1_All) == 0)
...
/** @defgroup PWM_TZ_Channel_Define Выбор номера сигнала аварии
  * @{
  */

#define PWM_TZ_Channel_0 0x00000001UL   /*!< Сигнал аварии 0 */
#define PWM_TZ_Channel_1 0x00000002UL   /*!< Сигнал аварии 1 */
#define PWM_TZ_Channel_2 0x00000004UL   /*!< Сигнал аварии 2 */
#define PWM_TZ_Channel_3 0x00000008UL   /*!< Сигнал аварии 3 */
#define PWM_TZ_Channel_4 0x00000010UL   /*!< Сигнал аварии 4 */
#define PWM_TZ_Channel_5 0x00000020UL   /*!< Сигнал аварии 5 */
#define PWM_TZ_Channel_All 0x0000003FUL /*!< Все сигналы выбраны */
...
#define IS_PWM_HR_FEATURE(PERIPH) (((PERIPH) == PWM0) || \
                                   ((PERIPH) == PWM1) || \
                                   ((PERIPH) == PWM2) || \
                                   ((PERIPH) == PWM3) || \
                                   ((PERIPH) == PWM4) || \
...
#define IS_PWM_HR_DELAYCAL_VAL(VALUE) ((VALUE) < 0x4)
...
/**
  ...
  */
typedef enum {
    PWM_Sync_Serial, /*!< Последовательная синхронизация всех блоков: PWM0->PWM1->PWM2->...->PWM9 */
    PWM_Sync_Group1, /*!< Разбиение на группы синхронизации: PWM0->PWM1->PWM2->PWM3, PWM0->PWM4->PWM5->PWM6->PWM7->PWM8->PWM9 */
    PWM_Sync_Group2, /*!< Разбиение на группы синхронизации: PWM0->PWM1->PWM2->PWM3->PWM4->PWM5->PWM6, PWM0->PWM7->PWM8->PWM9 */
    PWM_Sync_Group3  /*!< Разбиение на группы синхронизации: PWM0->PWM1->PWM2->PWM3, PWM0->PWM4->PWM5->PWM6, PWM0->PWM7->PWM8->PWM9 */
} PWM_Sync_TypeDef;
#define IS_PWM_SYNC(VALUE) (((VALUE) == PWM_Sync_Serial) || \
                            ((VALUE) == PWM_Sync_Group1) || \
                            ((VALUE) == PWM_Sync_Group2) || \
                            ((VALUE) == PWM_Sync_Group3))
...
/**
  * @brief Событие для загрузки отложенного значения в активный регистр CMPAHR
  */
typedef enum {
    PWM_HR_LoadEvent_CTREqZero = PWM_HRCTL_HRLOAD_CTREqZero,  /*!< Загрузка отложенного значения при условии, что значение таймера равно нулю */
    PWM_HR_LoadEvent_CTREqPeriod = PWM_HRCTL_HRLOAD_CTREqPRD, /*!< Загрузка отложенного значения при условии, что значение таймера равно периоду */
} PWM_HR_LoadEvent_TypeDef;
#define IS_PWM_HR_LOAD_EVENT(VALUE) (((VALUE) == PWM_HR_LoadEvent_CTREqZero) || \
                                     ((VALUE) == PWM_HR_LoadEvent_CTREqPeriod))

/**
  * @brief Источник задержки высокого разрешения
  */
typedef enum {
    PWM_HR_Source_CMPAHR = PWM_HRCTL_CTLMODEA_CMPAHR,   /*!< Используется поле CMPAHR */
    PWM_HR_Source_TBPHSHR = PWM_HRCTL_CTLMODEA_TBPHSHR, /*!< Используется поле TBPHSHR */
} PWM_HR_Source_TypeDef;
#define IS_PWM_HR_SOURCE(VALUE) (((VALUE) == PWM_HR_Source_CMPAHR) || \
                                 ((VALUE) == PWM_HR_Source_TBPHSHR))

/**
  * @brief Выбор фронта, сдвигаемого линией задержки
  */
typedef enum {
    PWM_HR_Edge_Rise = PWM_HRCTL_EDGMODEA_PosEdge, /*!< Задержка переднего фронта  */
    PWM_HR_Edge_Fall = PWM_HRCTL_EDGMODEA_NegEdge, /*!< Задержка заднего фронта  */
    PWM_HR_Edge_Both = PWM_HRCTL_EDGMODEA_BothEdge /*!< Задержка обоих фронтов */
} PWM_HR_Edge_TypeDef;
#define IS_PWM_HR_EDGE(VALUE) (((VALUE) == PWM_HR_Edge_Rise) || \
                               ((VALUE) == PWM_HR_Edge_Fall) || \
                               ((VALUE) == PWM_HR_Edge_Both))
...
typedef struct
{
    ...
    uint32_t Source0;              /*!< Выбор источников группы 0 для генерации события удержания.
                                         Параметр принимает любую совокупность значений из @ref PWM_HD_Source0_Define */
    uint32_t Source1;              /*!< Выбор источников группы 1 для генерации события удержания.
                                        Параметр принимает любую совокупность значений из @ref PWM_HD_Source1_Define */
    FunctionalState CycleEn;       /*!< Включение циклической обработки сигнала удержания */
    FunctionalState OneShotEn;     /*!< Включение однократной обработки сигнала удержания */
} PWM_HD_Init_TypeDef;
...
typedef struct
{
    ...
    uint32_t CycleChannel;         /*!< Выбор каналов аварии для циклического режима
                                        Параметр принимает любую совокупность значений из @ref PWM_TZ_Channel_Define */
    uint32_t OneShotChannel;       /*!< Выбор каналов аварии для однократного режима
                                        Параметр принимает любую совокупность значений из @ref PWM_TZ_Channel_Define */
    FunctionalState CycleEn;       /*!< Включение циклической обработки сигнала аварии */
    FunctionalState OneShotEn;     /*!< Включение однократной обработки сигнала аварии */
} PWM_TZ_Init_TypeDef;
...
/**
  ...
  * @param   PWMx  Выбор PWM, где x лежит в диапазоне 0-9
...
/**
  ...
  * @param   Sync  Выбор схемы
  * @retval  void
  */
__STATIC_INLINE void PWM_SyncConfig(PWM_Sync_TypeDef Sync)
{
    assert_param(IS_PWM_SYNC(Sync));

    WRITE_REG(SIU->PWMSYNC_bit.SYNCSEL, (uint32_t)Sync);
}
...
/**
  * @brief   Выбор источников для генерации события удержания группа 0
  * @param   PWMx  Выбор PWM, где x лежит в диапазоне 0-9
  ...
  * @retval  void
  */
__STATIC_INLINE void PWM_HD_Source0Cmd(PWM_TypeDef* PWMx, uint32_t Source, FunctionalState State)
{
    assert_param(IS_PWM_PERIPH(PWMx));
    assert_param(IS_PWM_HD_SOURCE0(Source));

    MODIFY_REG(PWMx->HDSEL0, Source, State ? Source : 0);
}

/**
  * @brief   Выбор источников для генерации события удержания группа 1
  * @param   PWMx  Выбор PWM, где x лежит в диапазоне 0-9
  * @param   Source  Выбор источника
  *                  Параметр принимает любую совокупность значений из @ref PWM_HD_Source1_Define
  * @param   State  Выбор состояния
  * @retval  void
  */
__STATIC_INLINE void PWM_HD_Source1Cmd(PWM_TypeDef* PWMx, uint32_t Source, FunctionalState State)
{
    assert_param(IS_PWM_PERIPH(PWMx));
    assert_param(IS_PWM_HD_SOURCE1(Source));

    MODIFY_REG(PWMx->HDSEL1, Source, State ? Source : 0);
}
...
__STATIC_INLINE void PWM_HD_CycleCmd(PWM_TypeDef* PWMx, FunctionalState State)
{
    ...
    WRITE_REG(PWMx->HDCTL_bit.CBC, State);
}
...
__STATIC_INLINE void PWM_HD_OneShotCmd(PWM_TypeDef* PWMx, FunctionalState State)
{
    ...
    WRITE_REG(PWMx->HDCTL_bit.OST, State);
}
...
/**
  ...
  * @param   PWMx  Выбор PWM, где x лежит в диапазоне 0-9
  * @param   Channel  Выбор канала аварии
  *                   Параметр принимает любую совокупность значений из @ref PWM_TZ_Channel_Define
  * @param   State  Выбор состояния
  * @retval  void
  */
__STATIC_INLINE void PWM_TZ_CycleCmd(PWM_TypeDef* PWMx, uint32_t Channel, FunctionalState State)
{
    assert_param(IS_PWM_PERIPH(PWMx));
    assert_param(IS_PWM_TZ_CHANNEL(Channel));
    assert_param(IS_FUNCTIONAL_STATE(State));

    MODIFY_REG(PWMx->TZSEL, Channel << PWM_TZSEL_CBC0_Pos, State ? Channel << PWM_TZSEL_CBC0_Pos : 0);
}
...
/**
  ...
  * @retval  void
  */
__STATIC_INLINE void PWM_TZ_OneShotCmd(PWM_TypeDef* PWMx, uint32_t Channel, FunctionalState State)
{
    assert_param(IS_PWM_PERIPH(PWMx));
    assert_param(IS_PWM_TZ_CHANNEL(Channel));
    assert_param(IS_FUNCTIONAL_STATE(State));

    MODIFY_REG(PWMx->TZSEL, Channel << PWM_TZSEL_OST0_Pos, State ? Channel << PWM_TZSEL_OST0_Pos : 0);
}
...
/** @defgroup PWM_Exported_Functions_PWM_HighResolution Блок "высокого разрешения"
  * @{
  */

/**
  * @brief   Настройка задержки высокого разрешения по каналу A
  * @param   PWMx  Выбор PWM, где x лежит в диапазоне 0-5
  * @param   Source  Выбор источника задержки
  * @param   Edge  Выбор фронта задержки
  * @retval  void
  */
__STATIC_INLINE void PWM_HR_AConfig(PWM_TypeDef* PWMx, PWM_HR_Source_TypeDef Source, PWM_HR_Edge_TypeDef Edge)
{
    assert_param(IS_PWM_HR_FEATURE(PWMx));
    assert_param(IS_PWM_HR_SOURCE(Source));
    assert_param(IS_PWM_HR_EDGE(Edge));

    MODIFY_REG(PWMx->HRCTL, PWM_HRCTL_CTLMODEA_Msk | PWM_HRCTL_EDGMODEA_Msk,
               ((Source << PWM_HRCTL_CTLMODEA_Pos) |
                (Edge << PWM_HRCTL_EDGMODEA_Pos)));
}

/**
  * @brief   Настройка задержки высокого разрешения по каналу B
  * @param   PWMx  Выбор PWM, где x лежит в диапазоне 0-5
  * @param   Source  Выбор источника задержки
  * @param   Edge  Выбор фронта задержки
  * @retval  void
  */
__STATIC_INLINE void PWM_HR_BConfig(PWM_TypeDef* PWMx, PWM_HR_Source_TypeDef Source, PWM_HR_Edge_TypeDef Edge)
{
    assert_param(IS_PWM_HR_FEATURE(PWMx));
    assert_param(IS_PWM_HR_SOURCE(Source));
    assert_param(IS_PWM_HR_EDGE(Edge));

    MODIFY_REG(PWMx->HRCTL, PWM_HRCTL_CTLMODEB_Msk | PWM_HRCTL_EDGMODEB_Msk,
               ((Source << PWM_HRCTL_CTLMODEB_Pos) |
                (Edge << PWM_HRCTL_EDGMODEB_Pos)));
}

/**
  * @brief   Настройка cобытия для теневой загрузки в регистр CMPAHR
  * @param   PWMx  Выбор ШИМ, где x лежит в диапазоне 0-5
  * @param   LoadEvent  Выбор события
  * @retval  void
  */
__STATIC_INLINE void PWM_HR_LoadEventConfig(PWM_TypeDef* PWMx, PWM_HR_LoadEvent_TypeDef LoadEvent)
{
    assert_param(IS_PWM_HR_FEATURE(PWMx));
    assert_param(IS_PWM_HR_LOAD_EVENT(LoadEvent));

    WRITE_REG(PWMx->HRCTL_bit.HRLOAD, LoadEvent);
}

/**
  * @brief   Установка флагов калибровки канала A
  * @param   PWMx  Выбор PWM, где x лежит в диапазоне 0-5
  * @param   DelayCalVal  Значение в диапазоне 0-3
  * @retval  void
  */
__STATIC_INLINE void PWM_HR_SetDelayCalA(PWM_TypeDef* PWMx, uint32_t DelayCalVal)
{
    assert_param(IS_PWM_HR_FEATURE(PWMx));
    assert_param(IS_PWM_HR_DELAYCAL_VAL(DelayCalVal));

    WRITE_REG(PWMx->HRCTL_bit.DELAYCALA, DelayCalVal);
}

/**
  * @brief   Получение текущего значения флагов калибровки канала A
  * @param   PWMx  Выбор PWM, где x лежит в диапазоне 0-5
  * @retval  Val  Значение сравнения
  */
__STATIC_INLINE uint32_t PWM_HR_GetDelayCalA(PWM_TypeDef* PWMx)
{
    assert_param(IS_PWM_HR_FEATURE(PWMx));

    return READ_REG(PWMx->HRCTL_bit.DELAYCALA);
}

/**
  * @brief   Установка флагов калибровки канала B
  * @param   PWMx  Выбор PWM, где x лежит в диапазоне 0-5
  * @param   DelayCalVal  Значение в диапазоне 0-3
  * @retval  void
  */
__STATIC_INLINE void PWM_HR_SetDelayCalB(PWM_TypeDef* PWMx, uint32_t DelayCalVal)
{
    assert_param(IS_PWM_HR_FEATURE(PWMx));
    assert_param(IS_PWM_HR_DELAYCAL_VAL(DelayCalVal));

    WRITE_REG(PWMx->HRCTL_bit.DELAYCALB, DelayCalVal);
}

/**
  * @brief   Получение текущего значения флагов калибровки канала B
  * @param   PWMx  Выбор PWM, где x лежит в диапазоне 0-5
  * @retval  Val  Значение сравнения
  */
__STATIC_INLINE uint32_t PWM_HR_GetDelayCalB(PWM_TypeDef* PWMx)
{
    assert_param(IS_PWM_HR_FEATURE(PWMx));

    return READ_REG(PWMx->HRCTL_bit.DELAYCALB);
}
