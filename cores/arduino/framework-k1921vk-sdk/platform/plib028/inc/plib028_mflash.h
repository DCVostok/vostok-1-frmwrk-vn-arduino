...
#ifndef __PLIB028_MFLASH_H
#define __PLIB028_MFLASH_H
...
typedef enum {
    ...
    MFLASH_Cmd_EraseFull = MFLASH_CMD_ERSEC_Msk | MFLASH_CMD_ALLSEC_Msk, /*!< Команда стирания всей памяти */
