...
#ifndef __PLIB028_TMR_H
#define __PLIB028_TMR_H
...
/**
  * @brief  Выбор источника внешнего тактирования таймера
  */
typedef enum {
    TMR_ExtInputSel_IO = SIU_TMRMUX_EXTINSEL0_IO,        /*!< Выбор порта ввода-вывода в качестве внешнего входа */
    TMR_ExtInputSel_RTC1kHz = SIU_TMRMUX_EXTINSEL0_RTC1K /*!< Выбор сигнала частотой 1 кГц от RTC в качестве внешнего входа */
} TMR_ExtInputSel_TypeDef;
#define IS_TMR_EXT_INPUT_SEL(VALUE) (((VALUE) == TMR_ExtInputSel_IO) || \
                                     ((VALUE) == TMR_ExtInputSel_RTC1kHz))
