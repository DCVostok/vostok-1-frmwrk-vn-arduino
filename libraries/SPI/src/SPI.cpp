...
#include "wiring_private.h"
  ...
  #define SPI_SCKDivConfig(spi,SCKDiv,SCKDivExtra) SPI_SCKDivConfig(SCKDiv,SCKDivExtra)
  #define SPI_SCKConfig(spi,SPI_SCKPhase,SPI_SCKPolarity) SPI_SCKConfig(SPI_SCKPhase,SPI_SCKPolarity)
...
void SPIClassK1921VK::init()
{
    ...
    if(_spi == NT_SPI0){
      //sclk A6, C9
      GPIO_StructInit(&GPIO_InitStruct);
      GPIO_InitStruct.GPIO_AltFunc = pin_description_SCK->port == NT_GPIOA ?  GPIO_AltFunc_1:GPIO_AltFunc_2;
      ...
      //mosi A1,C11
      GPIO_StructInit(&GPIO_InitStruct);
      GPIO_InitStruct.GPIO_AltFunc = pin_description_MOSI->port == NT_GPIOA ?  GPIO_AltFunc_1:GPIO_AltFunc_2;
      GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AltFunc;
      ...
      //miso A7,C10
      GPIO_StructInit(&GPIO_InitStruct);
      GPIO_InitStruct.GPIO_AltFunc = pin_description_MISO->port == NT_GPIOA ?  GPIO_AltFunc_1:GPIO_AltFunc_2;
      GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AltFunc;
    ...
    if(_spi == NT_SPI1){
      //sclk B1,E9
      GPIO_StructInit(&GPIO_InitStruct);
      GPIO_InitStruct.GPIO_AltFunc = pin_description_SCK->port == NT_GPIOB ?  GPIO_AltFunc_2:GPIO_AltFunc_3;
      GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AltFunc;
      GPIO_InitStruct.GPIO_Pin = pin_description_SCK->pin_msk;
      GPIO_InitStruct.GPIO_Dir = GPIO_Dir_Out;
      GPIO_InitStruct.GPIO_Out = GPIO_Out_En;
      ...
      //mosi A2,F0
      GPIO_StructInit(&GPIO_InitStruct);
      GPIO_InitStruct.GPIO_AltFunc = pin_description_MOSI->port == NT_GPIOA ?  GPIO_AltFunc_2:GPIO_AltFunc_3;
      GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AltFunc;
      GPIO_InitStruct.GPIO_Pin = pin_description_MOSI->pin_msk;
      GPIO_InitStruct.GPIO_Dir = GPIO_Dir_Out;
      GPIO_InitStruct.GPIO_Out = GPIO_Out_En;
      ...
      //miso B2,G2
      GPIO_StructInit(&GPIO_InitStruct);
      GPIO_InitStruct.GPIO_AltFunc = pin_description_MISO->port == NT_GPIOB ?  GPIO_AltFunc_2:GPIO_AltFunc_3;
      GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AltFunc;
      GPIO_InitStruct.GPIO_Pin = pin_description_MISO->pin_msk;
      GPIO_InitStruct.GPIO_Dir = GPIO_Dir_In;
      GPIO_InitStruct.GPIO_Out = GPIO_Out_Dis;
    ...
    if(_spi == NT_SPI2){
      //sclk G5,B14
      GPIO_StructInit(&GPIO_InitStruct);
      GPIO_InitStruct.GPIO_AltFunc = pin_description_SCK->port == NT_GPIOG ?  GPIO_AltFunc_2:GPIO_AltFunc_3;
      GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AltFunc;
      GPIO_InitStruct.GPIO_Pin = pin_description_SCK->pin_msk;
      GPIO_InitStruct.GPIO_Dir = GPIO_Dir_Out;
      GPIO_InitStruct.GPIO_Out = GPIO_Out_En;
      ...
      //mosi G6,C6
      GPIO_StructInit(&GPIO_InitStruct);
      GPIO_InitStruct.GPIO_AltFunc = pin_description_MOSI->port == NT_GPIOG ?  GPIO_AltFunc_2:GPIO_AltFunc_3;
      GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AltFunc;
      GPIO_InitStruct.GPIO_Pin = pin_description_MOSI->pin_msk;
      GPIO_InitStruct.GPIO_Dir = GPIO_Dir_Out;
      GPIO_InitStruct.GPIO_Out = GPIO_Out_En;
      ...
      //miso F3,B15
      GPIO_StructInit(&GPIO_InitStruct);
      GPIO_InitStruct.GPIO_AltFunc = pin_description_MISO->port == NT_GPIOF ?  GPIO_AltFunc_2:GPIO_AltFunc_3;
      GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AltFunc;
      GPIO_InitStruct.GPIO_Pin = pin_description_MISO->pin_msk;
      GPIO_InitStruct.GPIO_Dir = GPIO_Dir_In;
      GPIO_InitStruct.GPIO_Out = GPIO_Out_Dis;
...
{
  const PinDescription *pin_description = PIN_GET_DESCRIPTION((pin_size_t)interruptNumber);
  noInterrupts();
...
void SPIClassK1921VK::setBitOrder(BitOrder order)
{
  _bitOrder = order;
}
...
{
    SPI_SCKPhase_TypeDef  SPI_SCKPhase = mode == SPI_MODE0 || mode == SPI_MODE2 ? SPI_SCKPhase_CaptureRise:SPI_SCKPhase_CaptureFall  ;
    SPI_SCKPolarity_TypeDef  SPI_SCKPolarity = mode == SPI_MODE0 || mode == SPI_MODE1 ? SPI_SCKPolarity_SteadyLow:SPI_SCKPolarity_SteadyHigh ;
...
void SPIClassK1921VK::detachInterrupt() {
  ...
  arduino::SPIClassK1921VK SPI (PERIPH_SPI,  PIN_SPI_MISO,  PIN_SPI_SCK,  PIN_SPI_MOSI);
#endif
#if SPI_INTERFACES_COUNT > 1
  arduino::SPIClassK1921VK SPI1 (PERIPH_SPI1,  PIN_SPI1_MISO,  PIN_SPI1_SCK,  PIN_SPI1_MOSI);
#endif
#if SPI_INTERFACES_COUNT > 2
  arduino::SPIClassK1921VK SPI2 (PERIPH_SPI2,  PIN_SPI2_MISO,  PIN_SPI2_SCK,  PIN_SPI2_MOSI);
#endif
#if SPI_INTERFACES_COUNT > 3
  arduino::SPIClassK1921VK SPI3 (PERIPH_SPI3,  PIN_SPI3_MISO,  PIN_SPI3_SCK,  PIN_SPI3_MOSI);
#endif
#if SPI_INTERFACES_COUNT > 4
  arduino::SPIClassK1921VK SPI4 (PERIPH_SPI4,  PIN_SPI4_MISO,  PIN_SPI4_SCK,  PIN_SPI4_MOSI);
#endif
#if SPI_INTERFACES_COUNT > 5
  arduino::SPIClassK1921VK SPI5 (PERIPH_SPI5,  PIN_SPI5_MISO,  PIN_SPI5_SCK,  PIN_SPI5_MOSI);
#endif
